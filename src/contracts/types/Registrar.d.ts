...
interface RegistrarInterface extends ethers.utils.Interface {
  functions: {
    ...
    "adminSetMetadataUri(uint256,string)": FunctionFragment;
    ...
    "registerDomainAndSendBulk(uint256,uint256,uint256,uint256,address,string,uint256,bool)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "adminSetMetadataUri",
  ...
  encodeFunctionData(
    functionFragment: "registerDomainAndSendBulk",
    values: [
      BigNumberish,
      BigNumberish,
      BigNumberish,
...
export type DomainCreatedEvent = TypedEvent<
  [
    BigNumber,
    string,
    BigNumber,
...
export type MetadataChangedEvent = TypedEvent<
  [BigNumber, string] & { id: BigNumber; uri: string }
>;

export type MetadataLockChangedEvent = TypedEvent<
...
export type RoyaltiesAmountChangedEvent = TypedEvent<
...
export class Registrar extends BaseContract {
  ...
  functions: {
    ...
    registerDomainAndSendBulk(
      parentId: BigNumberish,
      namingOffset: BigNumberish,
      startingIndex: BigNumberish,
      endingIndex: BigNumberish,
      minter: string,
      folderWithIPFSPrefix: string,
      royaltyAmount: BigNumberish,
      locked: boolean,
      overrides?: Overrides & { from?: string | Promise<string> }
    ): Promise<ContractTransaction>;
  ...
  callStatic: {
    ...
    setZNSHub(hub: string, overrides?: CallOverrides): Promise<void>;
  ...
  filters: {
    ...
    "MetadataLockChanged(uint256,address,bool)"(
      id?: BigNumberish | null,
      locker?: null,
      isLocked?: null
    ): TypedEventFilter<
    ...
    "RoyaltiesAmountChanged(uint256,uint256)"(
      id?: BigNumberish | null,
      amount?: null
    ): TypedEventFilter<
      [BigNumber, BigNumber],
